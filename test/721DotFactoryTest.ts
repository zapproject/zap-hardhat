...
describe('ZapBondage', () => {
  ...
  beforeEach(async () => {
    ...
    tokenFactory = (await genericTokenFactory.deploy()) as Erc721Factory;
    ...
    Erc721dotFactoryFactoryInstance=await dotFactoryFactory.deploy(coordinator.address, tokenFactory.address) as DotFactoryFactory;
